 ...
 * @author chanu
 */
public class AddExpensess extends javax.swing.JDialog {

    private static HashMap<String, String> typeMap = new HashMap<>();

    /**
     * Creates new form AddExpensess
     */
    public AddExpensess(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadTypes();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Expenses Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (type.equals("Select Type")) {
                JOptionPane.showMessageDialog(this, "Please Select Expences Type", "Warning", JOptionPane.WARNING_MESSAGE);

            } else if (name.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please Enter Your Expenses Name", "Warning", JOptionPane.WARNING_MESSAGE);

            } else if (name.length() > 45) {
                JOptionPane.showMessageDialog(this, "Expenses Name Must Contain LOWER THAN 45 characters", "Warning", JOptionPane.WARNING_MESSAGE);

            } else if (value.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please Enter Your Expenses Value", "Warning", JOptionPane.WARNING_MESSAGE);

            } else if (expenceDate == null) {
                JOptionPane.showMessageDialog(this, "Please Select Date", "Warning", JOptionPane.WARNING_MESSAGE);

            } else if (note.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please Enter Expenses Note", "Warning", JOptionPane.WARNING_MESSAGE);

            }

            MySQL.executeIUD("INSERT INTO `expenses` (`expense_type_id`,`name`,`value`,`note`,`date`) "
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddExpensess dialog = new AddExpensess(new javax.swing.JFrame(), true);
